...
The [V1 product-images directory](documentation/product-images/) contains photographs of the actual printed prototype:
...
- [STL files](stl/)
- [Bambu Studio project](bambu-studio-3mf/)
